...
from Cybruxo import anon, app, config, db, lang, queue, tasks, userbot, yt
from Cybruxo.helpers import buttons
    ...
    while True:
        ...
        for ub in userbot.clients:
            try:
                ...
                for chat in chats:
                    if chat in [app.logger, -1002135034807, -1002329214096]:
                        continue
