...
from Cybruxo import config
from Cybruxo.helpers import Track
...
class Thumbnail:
    def __init__(self):
        ...
        self.font1 = ImageFont.truetype("Cybruxo/helpers/Raleway-Bold.ttf", 30)
        self.font2 = ImageFont.truetype("Cybruxo/helpers/Inter-Light.ttf", 30)
